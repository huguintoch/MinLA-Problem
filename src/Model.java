...
public class Model {
    ...
    public Model(int n, int[][] adj) throws GRBException {
        env = new GRBEnv("log-minla.log");
        ...
        for (int u = 0; u < n; u++) {
            ...
            for (int v = 0; v < n; v++) {
                if (u != v) {
                    ...
                    x[u][v] = model.addVar(0, 0, 0, GRB.BINARY, "x_" + u + v);
                    w[u][v] = model.addVar(0, 0, 0, GRB.BINARY, "w_" + u + v);
                }
            }
        }
